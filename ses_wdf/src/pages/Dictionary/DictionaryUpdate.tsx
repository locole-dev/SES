...
import { SmartWatch } from '../../types/smart-watch.ts';
...
const DictionaryUpdate = () => {
  ...
  const onSubmit = async (e: React.FormEvent) => {
    ...
    const result = await apiService({ method:  "PUT" , url: "/saveDictionary", data: data });
            ...
            <div className="p-6.5">
              ...
              <div className="w-full  gap-3 mb-4 ">
                <MultiSelectGroup
                  ...
                  defaultValue={listSmartWatch.filter((item) => dictionary.key.includes(item.dictionaryKey))}
                  isDisabled={true}
