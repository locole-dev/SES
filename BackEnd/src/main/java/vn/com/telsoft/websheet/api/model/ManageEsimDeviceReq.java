...
public class ManageEsimDeviceReq {
    ...
    public String toString() {
        ...
        sb.append(ManageEsimDeviceReq.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("websheetSessionToken");
        sb.append('=');
        sb.append(((this.websheetSessionToken == null) ? "<null>" : this.websheetSessionToken));
        sb.append(',');
        sb.append("signupUrlPostData");
        sb.append('=');
