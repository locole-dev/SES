...
public class SubscriptionRecoveryReq {
    ...
    public String toString() {
        ...
        sb.append(SubscriptionRecoveryReq.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("uniqueId");
        sb.append('=');
