...
public class SubscriptionActivationReq {
    ...
    public String toString() {
        ...
        sb.append(SubscriptionActivationReq.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("uniqueId");
        sb.append('=');
        ...
        sb.append("planInfo");
        sb.append('=');
        sb.append(((this.planInfo == null) ? "<null>" : this.planInfo));
        sb.append(',');
