...
public class SubscriptionActivationRes extends CommonRes {
    ...
    public String toString() {
        ...
        sb.append(SubscriptionActivationRes.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("uniqueId");
        sb.append('=');
