...
public class SubscriptionDeactivationRes extends CommonRes {
    ...
    public String toString() {
        ...
        sb.append(SubscriptionDeactivationRes.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("uniqueId");
        sb.append('=');
